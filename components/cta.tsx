        ...
        <div className="rounded-3xl p-12 text-center bg-surface/80 backdrop-blur-xl border border-accent/20">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Button size="xl" className="group" asChild>
              <a href="https://apps.apple.com/il/app/songmap-ai-song-analyzer/id6762045630" aria-label="Download SongMap on the App Store" className="flex items-center gap-2">
